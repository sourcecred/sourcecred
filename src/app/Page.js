          ...
          <nav className={css(style.nav)}>
            <ul className={css(style.navList)}>
              ...
              <li className={css(style.navItem, style.navItemRight)}>
                ...
                >
                <GithubLogo altText="SourceCred Github" className={css(style.navLogo, style.navLogoHover)} />
                </a>
              </li>
              <li className={css(style.navItem, style.navItemRight)}>
                <a
                ...
                >
                <TwitterLogo altText="SourCred Twitter" className={css(style.navLogo, style.navLogoHover)} />
                </a>
              </li>
            </ul>
          </nav>
