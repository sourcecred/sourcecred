    ...
    <Grid container>
      <Grid container className={classes.weightConfig} spacing={2}>
        <Grid container item xs={12} direction="column">
          <Grid>
            <Grid>
              This page loads your current config/weights.json file, if it does
              not exist it would put the default values. Once you are done
              configuring weights, download the file and put it in your /config
              directory in your instance as weights.json. To see new scores,
              re-calculate scores using the CLI.
            </Grid>
            <Grid>
              <WeightsFileManager
                weights={weights}
